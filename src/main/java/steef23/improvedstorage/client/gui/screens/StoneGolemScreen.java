...
@OnlyIn(Dist.CLIENT)
public class StoneGolemScreen extends AbstractContainerScreen<StoneGolemMenu>
{
	...
	public StoneGolemScreen(StoneGolemMenu screenContainer, Inventory inv, Component titleIn)
	{
