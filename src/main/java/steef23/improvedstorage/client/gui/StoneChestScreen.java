...
@OnlyIn(Dist.CLIENT)
public class StoneChestScreen extends ContainerScreen<StoneChestContainer>
{
	...
	public StoneChestScreen(StoneChestContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) 
	{
